...
public class AdminService {
	...
	datosEjemplo.init();
	log.info("Se han borrado todos los usuarios y se han creado los usuarios aleatorios. Fecha: "
	...
	log.info("Se han borrado todos los usuarios y se han creado los usuarios por defecto. Fecha: "
		+ Calendar.getInstance().getTime());
    }
}
